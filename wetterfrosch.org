...
# Time-stamp: <2024-08-06 17:50:05 krylon>
#
...
** Clocktable
   ...
   #+CAPTION: Clock summary at [2024-08-06 Di 17:49]
   | Headline                                       | Time       |            |          |       |      |
   |------------------------------------------------+------------+------------+----------+-------+------|
   | *Total time*                                   | *4d 16:20* |            |          |       |      |
   |------------------------------------------------+------------+------------+----------+-------+------|
   | *Wetterfrosch*                                 | *4d 16:20* |            |          |       |      |
   | \_  /Features [5/6]/                           |            | /1d 21:48/ |          |       |      |
...
*** RESEARCH Graphs [0/0]                                     :ui:meditation:
    ...
    :END:
    :LOGBOOK:
    CLOCK: [2024-02-20 Di 00:35]--[2024-02-20 Di 00:45] =>  0:10
...
*** GUI [5/6]
   ...
   :END:
**** DONE Humid
     CLOSED: [2024-08-06 Di 17:49]
     :LOGBOOK:
     CLOCK: [2024-08-06 Di 17:01]--[2024-08-06 Di 17:49] =>  0:48
     CLOCK: [2024-08-06 Di 14:55]--[2024-08-06 Di 15:06] =>  0:11
     :END:
     I would like to display in the forecast view whether the the combination
     of temperature and humidity makes it schwül. I already to that elsewhere,

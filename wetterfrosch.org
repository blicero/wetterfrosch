...
# Time-stamp: <2024-01-19 23:59:49 krylon>
#
...
** Clocktable
   ...
   #+CAPTION: Clock summary at [2024-01-19 Fr 23:59]
   | Headline                           | Time       |            |       |       |
   |------------------------------------+------------+------------+-------+-------|
   | *Total time*                       | *1d 14:47* |            |       |       |
   |------------------------------------+------------+------------+-------+-------|
   | *Wetterfrosch*                     | *1d 14:47* |            |       |       |
   | \_  /Components [7/9]/             |            | /1d 14:47/ |       |       |
   | \_    Database                     |            |            | 13:03 |       |
   | \_    Load warnings from DWD [3/3] |            |            |  4:44 |       |
   | \_      Use requests library       |            |            |       |  0:23 |
   | \_      Location                   |            |            |       |  1:33 |
   | \_      Testing                    |            |            |       |  0:41 |
   | \_    GUI [2/3]                    |            |            | 21:00 |       |
   | \_      Location management        |            |            |       | 11:45 |
...
*** DONE Database
    ...
    every year.
*** DONE Load warnings from DWD [3/3]
